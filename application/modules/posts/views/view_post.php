<div class="post-page m-top-20">
    ...
    if (empty($view_post)) {
        ...
        <div class="post-holder grey-bg m-bot-40">
            ...
            <div class="post_details">
                <small><?= anchor('view_author_profile/' . $view_post['poster_id'],
    ...
    <?php if ($this->session->flashdata('CommentValidation')) : ?>

            <div class="col-md-10">
                <div class="alert alert-dismissible alert-danger">
                    <div class="flash_data">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                        <strong>Danger!</strong> <?php echo $this->session->flashdata('CommentValidation'); ?>
                    </div>
